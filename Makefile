...
harness_replay_dbop_toaster_${alloc}_${thread}.o:  $(HARNESS_C) $(JITD_TEST_H) $(HARNESS_H)
	@echo "#define STORAGE_JITD" > $(CONF_H)
...
harness_replay_node_toaster_${alloc}_${thread}.o:  $(HARNESS_C) $(JITD_TEST_H) $(HARNESS_H)
	@echo "#define STORAGE_JITD" > $(CONF_H)
