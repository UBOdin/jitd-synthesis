...
public  class LogicalPlanIntegrity$ {
   ...
   */
  public static final LogicalPlanIntegrity$ MODULE$ = null;
  public   LogicalPlanIntegrity$ ()  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  boolean hasUniqueExprIdsForOutput (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan plan)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  boolean checkIfSameExprIdNotReused (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan plan)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  boolean checkIfExprIdsAreGloballyUnique (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan plan)  { throw new RuntimeException(); }
}
