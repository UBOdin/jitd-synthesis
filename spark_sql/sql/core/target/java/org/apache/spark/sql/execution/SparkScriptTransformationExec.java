...
public  class SparkScriptTransformationExec extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.BaseScriptTransformationExec, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   SparkScriptTransformationExec (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> input, java.lang.String script, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> output, org.apache.spark.sql.execution.SparkPlan child, org.apache.spark.sql.execution.ScriptTransformationIOSchema ioschema)  { throw new RuntimeException(); }
