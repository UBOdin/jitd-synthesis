...
public  class OrcFilters {
   ...
   * @return (undocumented)
   */
  static public  org.apache.hadoop.hive.ql.io.sarg.PredicateLeaf.Type getPredicateLeafType (org.apache.spark.sql.types.DataType dataType)  { throw new RuntimeException(); }
  ...
  static protected  scala.collection.immutable.Map<java.lang.String, org.apache.spark.sql.execution.datasources.orc.OrcFiltersBase.OrcPrimitiveField> getSearchableTypeMap (org.apache.spark.sql.types.StructType schema, boolean caseSensitive)  { throw new RuntimeException(); }
}
